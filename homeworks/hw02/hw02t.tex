...
\date{Due \emph{in class} Monday, March 5, 2018 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read about all the concepts introduced in class online. This is your responsibility to supplement in-class with your own readings.
