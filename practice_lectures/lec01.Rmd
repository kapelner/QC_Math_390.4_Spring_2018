...
Let's try to build a data matrix similar to the one in the class example.



It worth knowing a couple more data structures in R. These are not "data [science] types", these are "[computer science] data types". The first is arrays which are multidimensional vectors
...
x[1, 1]
x[1, ]
class(x[1, ]) #note: not array anymore
