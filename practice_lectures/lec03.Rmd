...
inverse_quantile_obj = ecdf(X[, "salary"])
...
The second are "lists" which are ordered hashmaps or ordered dictionaries. if You don't know what this is, you should read about this online as it should have been covered in a intro to CS class.
