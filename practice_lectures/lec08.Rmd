---
title: "Lecture 8 MATH 390.4 Queens College"
author: "Professor Adam Kapelner"
date: "February 26, 2018"
---

Let's quickly recreate the sample data set from last time:
...
Now let's calculate the simple least squares coefficients and plot it:
...
ggplot(simple_df) + 
  ...
  stat_density(aes(x = null_residuals, fill = "red", alpha = 0.3, adjust = 0.8)) +
  theme(legend.position = "none")
```
...
You can skip a step by putting the formula in-line:
...
Now let's take a look at the factor variable as the predictor. We'll use `Origin` in this example:
...
and now ggplot can handle the line:
