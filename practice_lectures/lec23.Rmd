...
for (b in 1 : B){
  ...
  g_model = YARFCART(data.frame(x = x_train[bootstrap_indices_b]), y_train[bootstrap_indices_b])
...
We could generate many datasets and do the bias-variance decomposition and what you'll find is the bias will be low (like in the case of one tree) but the variance will be much curtailed. That's because we're using an average. Thus, MSE will decrease.
